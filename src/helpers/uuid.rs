...
pub fn parse_uuid_from_request(request: HttpRequest) -> Result<Uuid, Response<Body>> {
    ...
    match uuid_option {
        ...
        None => {
            return Err(JsonResponse::new(400, ResponseItem::new(
    ...
    match uuid_result {
        Err(error) => Err(JsonResponse::new(400, ResponseItem::new(
            ResponseStatus::Error,
